...
ratings <- read_tsv(here::here('posts/imdb_trailer_park_boys/data/title.ratings.popular.tsv.gz'))

episode <- read_tsv(here::here('posts/imdb_trailer_park_boys/data/title.episode.popular.tsv.gz'))
```
