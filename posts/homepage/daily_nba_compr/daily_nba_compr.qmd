...
description: "Daily NBA Predictions using 'compr': A Pairwise Competition Model Developed by Dr. Matt Higham and Myself"
---
...
## Today's Games (`r format(Sys.Date(), "%A, %B %d")`)
```{r fig.height = 1.5, fig.width = 8, echo = FALSE}
...
## Games `r format(Sys.Date() + 1, "%A, %B %d")`
...
## Games `r format(Sys.Date() + 2, "%A, %B %d")`
