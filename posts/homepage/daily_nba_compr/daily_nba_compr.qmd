...
# get the current year adding 1 as that is how www.basketball-reference.com denotes the year, it is the year the championship is played in
current_year <- as.numeric(format(Sys.Date(), "%Y"))

# make the url dynamically oull the year  
urls <- c(
  paste0("https://www.basketball-reference.com/leagues/NBA_", current_year, "_games-october.html"),
  paste0("https://www.basketball-reference.com/leagues/NBA_", current_year, "_games-november.html"),
  paste0("https://www.basketball-reference.com/leagues/NBA_", current_year, "_games-december.html"),
  paste0("https://www.basketball-reference.com/leagues/NBA_", current_year, "_games-january.html"),
  paste0("https://www.basketball-reference.com/leagues/NBA_", current_year, "_games-february.html"),
  paste0("https://www.basketball-reference.com/leagues/NBA_", current_year, "_games-march.html"),
  paste0("https://www.basketball-reference.com/leagues/NBA_", current_year, "_games-april.html"),
  paste0("https://www.basketball-reference.com/leagues/NBA_", current_year, "_games-may.html")
)
...
for (url in urls) {
  ...
  tryCatch({
    ...
    table_node <- html_nodes(page_html, "table")
    if (length(table_node) > 0) {
      df <- html_table(table_node[[1]], header = TRUE)
      dfs[[url]] <- df
    }
  }, error = function(e) {
    # Silently skip URLs that produce an error
  })
}
